...
def assemble_2x2_grid(images):
    """
    Combines 4 PIL.Image objects into a 2x2 grid.
    Args:
        images: list of 4 PIL.Image instances
    Returns:
        PIL.Image grid
    """
    assert len(images) == 4, "Expected 4 images for 2x2 grid"
    w, h = images[0].size
